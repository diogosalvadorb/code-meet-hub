...
-- 1. Create secure RLS policies for events that protect organizer emails
...
-- 2. Create secure RLS policies for profiles that protect user emails  
...
-- 3. Fix legacy data - update events with null user_id to prevent security bypass
-- First, let's see if there are any events with null user_id
